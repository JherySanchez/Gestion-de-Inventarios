        ...
        <div class="carousel-container">
            <div class="carousel-inner" id="carousel-inner">
                <div class="carousel-item active">
                    <img src="/img/Teclado.avif" alt="Teclado">
                </div>
                <div class="carousel-item">
                    <img src="/img/Webcam.avif" alt="Webcam">
                </div>
                <div class="carousel-item">
                    <img src="/img/Teclado.avif" alt="Repetido">
                </div>
            </div>
            <div class="carousel-nav">
                <button class="nav-button prev-btn"><span class="material-icons">chevron_left</span></button>
                <button class="nav-button next-btn"><span class="material-icons">chevron_right</span></button>
            </div>
        </div>
    </main>

    <footer class="main-footer">
        <div class="footer-item"><a href="#">Contacto</a></div>
        <div class="footer-item"><a href="#">Redes Sociales</a></div>
        <div class="footer-item"><a href="#">Dirección</a></div>
    </footer>
